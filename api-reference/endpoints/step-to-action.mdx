...
The interactions supported are: 
...
These are the interactions that can be executed with by the [browser actor](/api-reference/browser/browser-interactions) if desired.
