...
<ResponseField name="return" type="list[str]">
  ...
  If there are multiple chunks of text within the element, this will return a list of all those strings.
</ResponseField>
...
Here's a sample product from cgtrader.com (an asset marketplace):
